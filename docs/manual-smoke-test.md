...
- [ ] In Settings > Development, confirm Clear PMT Demo deletes only `PMT`, while Clear All Except PMT and PMTQA preserves both protected Projects. Confirm both cleanup paths preserve and detach private Documentation/Logs. Confirm Clear Users and Restore Initial Seed Data refuse to run while another user owns private content.
