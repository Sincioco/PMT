...
- [ ] Clear PMT browser preferences, log in, and confirm What's New shows only Days 39, 38, and 37 in a left navigation list with Day 39 selected.
...
- [ ] Choose `click here` in the footer and confirm the dialog closes, `#/release-notes` opens, and the latest release is at the top of the 37 available historical releases. Confirm no invented Day 10 or Day 11 entries appear because those source prompts do not exist.
...
- [ ] Set `pmt-release-notes-last-seen:{userId}` to `2026-07-14-day-27`, log in again, and confirm What's New shows only Days 39 through 28.
