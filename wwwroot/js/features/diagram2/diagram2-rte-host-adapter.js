...
import { createDiagram2Phase6Host } from "./diagram2-editor-phase6-host.js?v=20260801-diagram2-screen-capture-v1";
...
function bindDiagram2RteHostEvents(options = {}) {
  ...
  bindDiagram2EditorColorPickers(dialog, {
    ...
    previewColor: (name, color) => controller.previewSelectedObjectsStyle(name, color),
    notify
  });
