export const preferenceKeys = Object.freeze({
  ...
  releaseNotesView: "pmt-release-notes-view",
  releaseNotesSelected: "pmt-release-notes-selected",
  boardProject: "pmt-board-project",
  boardSprint: "pmt-board-sprint",
  boardSearch: "pmt-board-search",
  ...
  aboutTrackAlienEventsEnabled: "pmt-about-track-alien-events-enabled",
  ...
  sprintFilter: "pmt-sprint-filter",
  sprintSearch: "pmt-sprint-search",
  ...
  bugTsgReportFields: "pmt-bug-tsg-report-fields",
  bugTsgReportFilename: "pmt-bug-tsg-report-filename",
  scrumFilters: "pmt-scrum-filters",
  scrumFiltersVisible: "pmt-scrum-filters-visible",
  scrumEntryProject: "pmt-scrum-entry-project",
  scrumAutoRefresh: "pmt-scrum-auto-refresh",
  ...
  documentationSprint: "pmt-documentation-sprint",
  ...
  documentationCreatorFilters: "pmt-documentation-creator-filters",
  documentationLastEditorFilters: "pmt-documentation-last-editor-filters",
  ...
  diagramSelectedDocument: "pmt-diagram-selected-document",
  ...
  diagram2DiagnosticsVisible: "pmt-diagram2-diagnostics-visible"
});
