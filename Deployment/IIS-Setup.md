...
The current source release and every known deployed database are at Version 1.27, so there is no active database migration to run. The next database-affecting release must provide a forward migration beginning at Version 1.27.
