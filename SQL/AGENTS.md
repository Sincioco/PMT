...
- The current source and rebuild scripts are Version 1.23. `Migrations/PMT_1.22_to_1.23.sql` is the canonical one-time BDO upgrade that preserves the deployed Project as PMTQA and restores the resettable PMT demo; operators run its `Migrations/PMT_1.22_to_1.23_All.sql` wrapper.
