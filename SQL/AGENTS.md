...
- PMT Database Version 1.23 is the deployed BDO baseline as of July 20, 2026. The current source schema and rebuild scripts are Version 1.24 until that migration is deployed everywhere.
...
- The completed Version 1.22-to-1.23 migration, combined runner, and deployment runbook are historical artifacts under `Migrations/Migration History/`. The active forward migration is `Migrations/PMT_1.23_to_1.24.sql`, with `Migrations/PMT_1.23_to_1.24_All.sql` as the operator runner.
