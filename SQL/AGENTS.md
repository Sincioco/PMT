...
- PMT Database Version 1.22 is the deployed baseline as of July 16, 2026; the latest PMT release and current database schema are deployed to every known instance.
