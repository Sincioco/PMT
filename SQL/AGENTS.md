...
- PMT Database Version 1.23 is the deployed BDO baseline as of July 20, 2026. The current source schema, rebuild scripts, BDO Production, and every other known PMT instance are all at Version 1.23.
...
- The completed Version 1.22-to-1.23 migration, combined runner, and deployment runbook are historical artifacts under `Migrations/Migration History/`. The next database change starts with `Migrations/PMT_1.23_to_1.24.sql`.
