...
The active forward migration chain is `PMT_1.23_to_1.24.sql` then `PMT_1.24_to_1.25.sql`, with `PMT_1.23_to_1.25_All.sql` as the operator-facing SQLCMD runner. It must be applied to deployed Version 1.23 databases when deploying the matching application files. Do not edit the completed Version 1.23 migration to introduce new behavior.
