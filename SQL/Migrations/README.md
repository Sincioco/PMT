...
The active forward migration is `PMT_1.25_to_1.26.sql`, with `PMT_1.25_to_1.26_All.sql` as the operator-facing SQLCMD runner. It adds the new public PMT tutorial Documentation rows to existing Version 1.25 installs. Do not edit a completed historical migration to introduce new behavior.
