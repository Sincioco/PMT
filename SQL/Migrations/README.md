...
There is no active forward migration because the deployed baseline and current source schema are both Version 1.27. The next database-affecting release must add `PMT_1.27_to_1.28.sql`.
