...
The current source schema is Version 1.13. Apply these migrations in order to every existing Version 1.10 installation:
...
The deployed baseline is not considered upgraded to Version 1.13 until all three migrations are actually applied and verified on each instance. Start with the migration immediately after the version already installed on that instance.
