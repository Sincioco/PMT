...
The current source schema is Version 1.7. Apply these migrations in order to upgrade the deployed Version 1.3 database:
...
The BDO baseline is not considered upgraded until all four migrations are actually deployed and verified.
