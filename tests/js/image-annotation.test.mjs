...
test("RTE Insert Linked Diagram stores a database-backed Diagram OLE reference", async () => {
  ...
  assert.match(appSource, /function richDiagramOleHeader/);
  assert.match(appSource, /function richDiagramOleTabs/);
  assert.match(appSource, /function richDiagramOleWriteTabs/);
  assert.match(appSource, /function richDiagramOleActiveTabStorageKey/);
  assert.match(appSource, /function readRichDiagramOleStoredActiveTabId/);
  assert.match(appSource, /function rememberRichDiagramOleActiveTab/);
  assert.match(appSource, /pmt-diagram-ole-active-tab:\$\{persistType\}:\$\{documentId\}:\$\{block\.dataset\.blockId \|\| "block"\}/);
  ...
  assert.match(appSource, /function syncRichDiagramOleMaximizedBodyClass/);
  assert.match(appSource, /pmt-diagram-ole-maximized:\$\{persistType\}:\$\{documentId\}:\$\{block\.dataset\.blockId \|\| "block"\}/);
  assert.match(appSource, /const storedMaximized = readRichDiagramOleStoredMaximized\(block\)/);
  ...
  assert.match(textSource, /function diagramOleHeaderForStorage/);
  ...
  assert.match(textSource, /data-header/);
